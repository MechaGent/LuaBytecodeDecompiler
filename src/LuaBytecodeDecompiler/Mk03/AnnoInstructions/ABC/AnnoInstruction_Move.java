...
public class AnnoInstruction_Move extends AnnoInstruction
{
	private final AnnoVar target;
	private AnnoVar source;

	public AnnoInstruction_Move(int inRaw, int inI, AnnoVar inTarget, AnnoVar inSource)
	{
		super(inRaw, inI, InstructionTypes.iABC, AbstractOpCodes.Move);
