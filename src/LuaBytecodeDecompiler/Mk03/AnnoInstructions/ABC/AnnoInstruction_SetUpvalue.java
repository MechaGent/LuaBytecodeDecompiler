...
public class AnnoInstruction_SetUpvalue extends AnnoInstruction
{
	private AnnoVar target;
	private AnnoVar source;

	public AnnoInstruction_SetUpvalue(int raw, int inI, AnnoVar inTarget, AnnoVar inSource)
	{
		super(raw, inI, InstructionTypes.iABC, AbstractOpCodes.SetUpvalue);
